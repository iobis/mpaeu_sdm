...
library(dplyr)
library(terra)
source("functions/model_species_esm.R")
...
algo_opts$features <- c("lq", "h")
algo_opts$remult <- seq_len(4)
...
# Metric threshold
tg_threshold <- 0.3
# Check at which conditions try to redo
esm_to_do <- c("low_data", "no_data")
